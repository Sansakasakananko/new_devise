...
class PostUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post_user" do
    assert_difference("PostUser.count") do
      post post_users_url, params: { post_user: { User_id: @post_user.User_id, post_id: @post_user.post_id } }
    end
  ...
  test "should update post_user" do
    patch post_user_url(@post_user), params: { post_user: { User_id: @post_user.User_id, post_id: @post_user.post_id } }
